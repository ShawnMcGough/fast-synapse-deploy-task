...
export class azureclitask {
    ...
    public static async runMain(): Promise<void> {
        ...
        try {
            ...
            console.log(`getting inputs for logging in to Azure...`);
            ...
            if(toolExecutionError === FAIL_ON_STDERR) {
                ...
                var errorMessage = toolExecutionError instanceof Error ? toolExecutionError.message : String(toolExecutionError);
                tl.setResult(tl.TaskResult.Failed, "ScriptFailed: " + errorMessage);
            } else if (exitCode != 0){
